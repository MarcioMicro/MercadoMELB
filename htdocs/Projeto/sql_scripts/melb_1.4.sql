...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25-Maio-2023 às 16:49
...
(21, 'luiz', '037.781.820-80', '(54) 99702-4060', '2003-12-19', 'luiz@uricer.edu.br', 51);
...
INSERT INTO `niveis_acesso` (`id`, `id_func`, `acesso_estoque`, `acesso_clientes`, `acesso_funcionarios`, `acesso_vendas`, `acesso_niveis`) VALUES
(1, 1000, 's', 's', 's', 's', 's'),
(2, 1001, 'n', 'n', 's', 'n', 's'),
(3, 1002, 's', 's', 'n', 's', 'n'),
(4, 1003, 'n', 'n', 'n', 'n', 'n'),
