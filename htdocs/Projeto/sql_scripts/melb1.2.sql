...
--
-- Host: 127.0.0.1
-- Tempo de geração: 12-Maio-2023 às 17:19
...
CREATE TABLE `niveis_acesso` (
  ...
  `acesso_produtos` enum('s','n') DEFAULT NULL,
...
INSERT INTO `niveis_acesso` (`id`, `id_func`, `acesso_estoque`, `acesso_produtos`, `acesso_funcionarios`, `acesso_vendas`, `acesso_niveis`) VALUES
(1, 1000, 's', 's', 's', 's', 's'),
(2, 1001, 'n', 'n', 's', 'n', 's'),
(3, 1002, 's', 's', 'n', 's', 'n'),
(4, 1003, 'n', 'n', 'n', 'n', 'n'),
