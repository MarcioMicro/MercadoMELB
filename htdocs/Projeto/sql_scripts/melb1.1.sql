...
(21, 'Maria Silva', '111.111.111-11', '(54) 99999-1111', '1990-01-01', 'maria.silva@email.com', 21),
(22, 'João Santos', '222.222.222-22', '(54) 99999-2222', '1985-02-02', 'joao.santos@email.com', 22),
(23, 'Pedro Oliveira', '333.333.333-33', '(54) 99999-3333', '1998-03-03', 'pedro.oliveira@email.com', 23),
(24, 'Ana Rodrigues', '444.444.444-44', '(54) 99999-4444', '1992-04-04', 'ana.rodrigues@email.com', 24),
(25, 'Lucas Almeida', '555.555.555-55', '(54) 99999-5555', '1987-05-05', 'lucas.almeida@email.com', 25),
(26, 'Camila Costa', '666.666.666-66', '(54) 99999-6666', '1995-06-06', 'camila.costa@email.com', 26),
(27, 'Eduardo Pereira', '777.777.777-77', '(54) 99999-7777', '1989-07-07', 'eduardo.pereira@email.com', 27),
(28, 'Mariana Fernandes', '888.888.888-88', '(54) 99999-8888', '1991-08-08', 'mariana.fernandes@email.com', 28),
(29, 'Rafael Souza', '999.999.999-99', '(54) 99999-9999', '1993-09-09', 'rafael.souza@email.com', 29),
(30, 'Juliana Lima', '000.000.000-00', '(54) 99999-0000', '1986-10-10', 'juliana.lima@email.com', 30),
(31, 'Fernando Santos', '111.111.111-12', '(54) 99999-1112', '1984-11-11', 'fernando.santos@email.com', 31),
(32, 'Carolina Oliveira', '222.222.222-23', '(54) 99999-2223', '1997-12-12', 'carolina.oliveira@email.com', 32),
(33, 'Roberto Pereira', '333.333.333-34', '(54) 99999-3334', '1988-01-13', 'roberto.pereira@email.com', 33),
(34, 'Patrícia Fernandes', '444.444.444-45', '(54) 99999-4445', '1990-02-14', 'patricia.fernandes@email.com', 34),
(35, 'Guilherme Almeida', '555.555.555-56', '(54) 99999-5556', '1997-08-12', 'guilherme.almeida@email.com', 35),
(36, 'Larissa Costa', '666.666.666-67', '(54) 99999-6667', '1992-03-15', 'larissa.costa@email.com', 36),
(37, 'Alexandre Santos', '777.777.777-78', '(54) 99999-7778', '1986-04-16', 'alexandre.santos@email.com', 37),
(38, 'Helena Rodrigues', '888.888.888-89', '(54) 99999-8889', '1998-05-17', 'helena.rodrigues@email.com', 38),
(39, 'Rodrigo Pereira', '999.999.999-90', '(54) 99999-9990', '1991-06-18', 'rodrigo.pereira@email.com', 39),
(40, 'Amanda Fernandes', '000.000.000-01', '(54) 99999-0001', '1993-07-19', 'amanda.fernandes@email.com', 40);
...
INSERT INTO `config` (`id`, `chave`, `valor`, `descricao`) VALUES
(1, 'desconto_cliente', '3', 'Porcentagem de desconto dada a clientes cadastrados que preencham seu CPF no caixa.');
...
(41, 'Fornecimentos Inc.', '11.111.111/0001-01', '(54) 99999-1111', 'fornecimentos@email.com', 'João da Silva', 41),
(42, 'Suprimentos Rápidos', '22.222.222/0001-02', '(54) 99999-2222', 'suprimentosrapidos@email.com', 'Maria Santos', 42),
(43, 'Distribuição Eficiente', '33.333.333/0001-03', '(54) 99999-3333', 'distribuicaoeficiente@email.com', 'Pedro Oliveira', 43),
(44, 'Logística Inteligente', '44.444.444/0001-04', '(54) 99999-4444', 'logisticainteligente@email.com', 'Ana Pereira', 44),
(45, 'Comércio Global Ltda.', '55.555.555/0001-05', '(54) 99999-5555', 'comercioglobal@email.com', 'Carlos Costa', 45),
(46, 'Importação Expressa', '66.666.666/0001-06', '(54) 99999-6666', 'importacaoexpressa@email.com', 'Mariana Ferreira', 46),
(47, 'Exportação Veloz', '77.777.777/0001-07', '(54) 99999-7777', 'exportacaoveloz@email.com', 'Rafael Souza', 47),
(48, 'Suprimentos em Foco', '88.888.888/0001-08', '(54) 99999-8888', 'suprimentosfoco@email.com', 'Luiza Lima', 48),
(49, 'Distribuição Ágil Ltda.', '99.999.999/0001-09', '(54) 99999-9999', 'distribuicaoagil@email.com', 'Gustavo Santos', 49),
(50, 'Comércio Moderno S.A.', '10.000.000/0001-10', '(54) 99999-0000', 'comerciomoderno@email.com', 'Patricia Oliveira', 50);
...
CREATE TABLE `vendas` (
  ...
  `valor_total` decimal(10,2) DEFAULT NULL,
  `is_cliente` tinyint(1) DEFAULT NULL,
  `id_funcionarios` int(11) NOT NULL,
...
ALTER TABLE `niveis_usuario`
  ADD PRIMARY KEY (`id_funcionarios`,`id_niveis_acesso`),
  ADD KEY `fk_niveis_acesso_has_Usuario_niveis_acesso1` (`id_niveis_acesso`);
...
--
-- Limitadores para a tabela `niveis_usuario`
--
ALTER TABLE `niveis_usuario`
  ADD CONSTRAINT `fk_niveis_acesso_has_Usuario_niveis_acesso1` FOREIGN KEY (`id_niveis_acesso`) REFERENCES `niveis_acesso` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_niveis_usuario_funcionarios1` FOREIGN KEY (`id_funcionarios`) REFERENCES `funcionarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
